...
// import logo from './assets/jobplatformlogo-removebg-new.png';
...
function Footer() {
  return (
    ...
    // </footer>
    <div><footer class="bg-[#0a4275] font-sans tracking-wide">
    <div class="py-14 px-6 sm:px-10">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">

        <div class="lg:col-span-2">
          <a href='javascript:void(0)'><img src="src\assests\images\jobplatformlogo-removebg-new.png" alt="logo"
            class='w-44 mb-8' /></a>
          <p class="text-gray-300 text-sm">Your ultimate destination for job seekers and employers, connecting talent with opportunity.</p>
        </div>
        ...
        <div>
          ...
          <div class="space-y-4">
            <p class="text-gray-300 text-sm">Plot No 16 Shriram Nagar,Udya Nagar Square,
                                                                            Manewala Road,Nagpur</p>
            <p class="text-gray-300 text-sm">info@jobplatform.co.in</p>
            <p class="text-gray-300 text-sm">+91 7709130494</p>
          </div>
        </div>
    ...
    <div class="text-center py-5 bg-[#08355e]">
      <p class='text-gray-300 text-sm'>© JobPlatform. All rights reserved.</p>
    </div>
  </footer></div>
  );
}
