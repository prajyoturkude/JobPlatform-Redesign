...
function Team() {
  return (
    ...
    <div class="max-w-5xl max-md:max-w-xl max-sm:max-w-sm mx-auto -mt-48 px-6">
        <h2 class="text-4xl max-md:text-3xl text-center font-extrabold text-white mb-12">Meet Our Professional Team</h2>
        ...
        <div class="grid md:grid-cols-3 sm:grid-cols-2 gap-8 max-sm:justify-center text-center">
            <div class="bg-white rounded-lg p-6 shadow-md hover:scale-105 transition-all duration-500">
                ...
                <div class="mt-6">
                    <h4 class="text-gray-800 text-lg font-bold">Roshan Sir</h4>
            ...
            <div class="bg-white rounded-lg p-6 shadow-md hover:scale-105 transition-all duration-500">
                ...
                <div class="mt-6">
                    <h4 class="text-gray-800 text-lg font-bold">Aditya Sir</h4>
                    <p class="text-sm text-gray-600 mt-1">Software Engineer</p>
