...
export const Stats = () => {
  return (
    <div><div class="bg-gray-50 p-8 min-h-[350px] flex items-center justify-center font-sans">
    <div class="bg-white shadow-[0_4px_24px_-8px_rgba(0,0,0,0.2)] grid lg:grid-cols-4 sm:grid-cols-2 sm:gap-24 gap-12 rounded-3xl px-20 py-10">
      ...
      <div class="text-center">
        ...
        <p class="text-gray-500 text-base font-semibold mt-3">Happy Students</p>
      </div>
      <div class="text-center">
        <h3 class="text-gray-800 text-4xl font-extrabold">100<span class="text-blue-600">K</span></h3>
        <p class="text-gray-500 text-base font-semibold mt-3">Happy Clients</p>
      </div>
      <div class="text-center">
